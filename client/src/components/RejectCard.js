				...
				<div className={styles.innerdiv}>
					...
					<div className={styles.innermost}>
						<div className={styles.btncontainer}>
							...
							<button className={styles.verifybutton} onClick={() => getundo()}>
								<img src={undo} className={styles.butimgdiv} alt=""></img>
							</button>
							<button className={styles.verifybutton} onClick={() => getdelete()}>
								<img src={deletelogo} className={styles.butimgdiv} alt=""></img>
							</button>
						</div>
					</div>
				</div>
